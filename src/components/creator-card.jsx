...
const CreatorCard = ({ creator }) => {
    ...
    return (<>
        <article style={{ width: '350px', maxHeight: '250px', margin: 'auto', backgroundImage: `url(${imageURL})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundColor: '#333333', backgroundBlendMode: 'multiply' }} >
            <div>
